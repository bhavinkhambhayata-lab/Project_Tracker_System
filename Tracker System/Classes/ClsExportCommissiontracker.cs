...
{
    public class ClsExportCommissiontracker
    {
      ...
      public int employeeRowId = 0;
        ...
        public List<ExportCommissiontracker> GetAllFyear()
        {
            connection();
            List<ExportCommissiontracker> lstFyear = new List<ExportCommissiontracker>();
      ...
      // this for update commission list 
        ...
        {
            connection();
            SqlCommand com = new SqlCommand("CTExportCommissionTrackerData", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        public string GetDataUpadateDetails(string OCF_No, string Invoice_No, string PI_No, string Claimform_Received, string CommissionInvoice_Received, string CommissionworkingsenttoVendor_Employee, string Credit_Advice_Prepared, string Credit_Advice_Details, string Credit_Note_Prepared, string Commission_Vendor_Name, string Vendor_Code, string FromNo, string CreditNotePreparedNo)
        {
            connection();
            SqlCommand com = new SqlCommand("CTCommissionTrackerDetails_For_Update_Data", con);
            com.CommandType = CommandType.StoredProcedure;
            ...
            com.Parameters.AddWithValue("@Commission_Invoice_Received", CommissionInvoice_Received ?? (object)DBNull.Value);
        ...
        public bool GetDataUpadatePreMarketing(ExportCommissiontracker model)
             {
                    connection();
                    SqlCommand com = new SqlCommand("CTExportCommissionTrackerData", con);
                    com.CommandType = CommandType.StoredProcedure;
        ...
        public bool GetDataUpadateCommercial(ExportCommissiontracker model)
        {
            connection();
            SqlCommand com = new SqlCommand("CTExportCommissionTrackerData", con);
            com.CommandType = CommandType.StoredProcedure;
            ...
            com.Parameters.AddWithValue("@Credit_Advice_Prepared", model.Credit_Advice_Prepared);
